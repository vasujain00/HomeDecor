		...
		<div class="col-md-12">
            ...
            <span class="navimg" id="right"><a class="arrow-next"><img src="image/sliders/slider-right.png"></a></span>
              ...
              <div class="slide active-slide">
                <div class="container-fluid">
                  <div class="row">
                    <img class="slide-img" src="image/sliders/img1.png" >
                  </div>
                </div>
              </div>
              <div class="slide">
                <div class="container-fluid">
                  <div class="row">
                     <img class="slide-img" src="image/sliders/img2.png" >
                  </div>
                </div>
              </div>
              <div class="slide">
                <div class="container-fluid">
                  <div class="row">
                     <img class="slide-img" src="image/sliders/img3.png" >
                  </div>
                </div>
              </div>
              ...
              <div class="slide">
                <div class="container-fluid">
                  <div class="row">
                     <img class="slide-img" src="image/sliders/img4.png" >
                  </div>
                </div>
              </div>
              ...
              <div class="slide">
                <div class="container-fluid">
                  <div class="row">
                     <img class="slide-img" src="image/sliders/img5.png" >
                  </div>
                </div>
              </div>
