...
<ul>
 ...
 <table class="table table-striped table-bordered">
            <caption><h3 class="text-info" style="text-align:center">Following Customers have purchased the item in 2015 but not in 2016</h3></caption>
            <thead>
                <tr class="info ">
                <th>Sr. No.</th>
                <th>First Name</th>
